...
import { DepositeImgData } from './DepositeWithdrawData';


export default function InteractiveTimeline({ isReverse = false, data = DepositeImgData, isFlexCol = false }) {
            ...
            <div className="flex flex-col justify-center items-center">
                <div className={`flex justify-center items-center gap-5 p-6 ${isReverse ? 'flex-row-reverse' : ''} ${isFlexCol ? 'flex-col' : ''}`}>
                    <div className='w-full'>
                        <img className='w-full' rel="preload" fetchpriority="high" as="image" type="image/svg" src={data.src} alt={data.alt} />
                    </div>
